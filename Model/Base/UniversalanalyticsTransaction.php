...
abstract class UniversalanalyticsTransaction implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\GoogleUniversalAnalytics\\Model\\Map\\UniversalanalyticsTransactionTableMap';
    ...
    /**
     * Compares this with another <code>UniversalanalyticsTransaction</code> instance.  If
     * <code>obj</code> is an instance of <code>UniversalanalyticsTransaction</code>, delegates to
     * <code>equals(UniversalanalyticsTransaction)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return UniversalanalyticsTransaction The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[UniversalanalyticsTransactionTableMap::ID] = true;
        }
    ...
    public function setClientid($v)
    {
        ...
        if ($this->clientid !== $v) {
            $this->clientid = $v;
            $this->modifiedColumns[UniversalanalyticsTransactionTableMap::CLIENTID] = true;
        }
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[UniversalanalyticsTransactionTableMap::ORDER_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UniversalanalyticsTransactionTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UniversalanalyticsTransactionTableMap::translateFieldName('Clientid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->clientid = (null !== $col) ? (string) $col : null;
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildUniversalanalyticsTransactionQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see UniversalanalyticsTransaction::setDeleted()
     * @see UniversalanalyticsTransaction::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildUniversalanalyticsTransactionQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UniversalanalyticsTransactionTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UniversalanalyticsTransactionTableMap::ID)) {
            $modifiedColumns[':p' . $index++]  = 'ID';
        }
        if ($this->isColumnModified(UniversalanalyticsTransactionTableMap::CLIENTID)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'ID':
                        ...
                        break;
                    case 'CLIENTID':
                        $stmt->bindValue($identifier, $this->clientid, PDO::PARAM_STR);
                        break;
                    case 'ORDER_ID':
    ...
    {
        $pos = UniversalanalyticsTransactionTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UniversalanalyticsTransaction'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UniversalanalyticsTransaction'][$this->getPrimaryKey()] = true;
        $keys = UniversalanalyticsTransactionTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(UniversalanalyticsTransactionTableMap::DATABASE_NAME);
        $criteria->add(UniversalanalyticsTransactionTableMap::ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \GoogleUniversalAnalytics\Model\UniversalanalyticsTransaction (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \GoogleUniversalAnalytics\Model\UniversalanalyticsTransaction Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(UniversalanalyticsTransactionTableMap::DEFAULT_STRING_FORMAT);
    }
